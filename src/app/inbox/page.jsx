          ...
          <div className="flex h-full flex-col border-l border-stroke dark:border-strokedark lg:w-4/5">
                      ...
                      <div class="flex items-center">
                        ...
                        <span class="pr-3">
                          <svg
                            ...
                            class="fill-[#E5E7EE] dark:fill-[#E5E7EE]/70"
                          >
                            <path
            ...
            <div class="flex items-center justify-between border-t border-stroke p-4 dark:border-strokedark sm:px-6">
              ...
              <div class="flex items-center justify-end space-x-3">
                <button class="flex h-7.5 w-7.5 items-center justify-center rounded border border-stroke bg-whiten hover:border-primary hover:bg-primary hover:text-white dark:border-strokedark dark:bg-whiten/30">
                  <svg
                    width="18"
                    height="18"
                    viewBox="0 0 18 18"
